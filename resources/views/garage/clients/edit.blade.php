...
@section('title', 'Modifier un client - Garage 2KYD')
...
<div class="p-5 rounded-4 text-white mb-4" style="background: linear-gradient(135deg, #7c3aed, #2563eb);">
    <h1 class="fw-bold">Modifier le client</h1>
    <p class="mb-0">
        Mettez à jour les informations de {{ $client->prenom }} {{ $client->nom }}.
    </p>
</div>
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('garage.clients.update', $client) }}">
            @csrf
            @method('PUT')
