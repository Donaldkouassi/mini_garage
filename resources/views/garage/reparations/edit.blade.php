...
@section('title', 'Modifier une réparation - Garage 2KYD')
...
<div class="form-page-header">
    ...
    <p>
        Mettez à jour les informations de la réparation et les techniciens affectés.
    </p>
</div>
...
<div class="form-card">
    ...
    <div class="form-card-body">
        <form method="POST" action="{{ route('garage.reparations.update', $reparation) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                        ...
                        <select name="vehicule_id" id="vehicule_id" class="form-select" required>
                            ...
                            @foreach($vehicules as $vehicule)
                                <option value="{{ $vehicule->id }}"
                                    @selected(old('vehicule_id', $reparation->vehicule_id) == $vehicule->id)>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control"
                                   value="{{ old('duree_main_oeuvre', intval($reparation->duree_main_oeuvre)) }}"
                                   min="1"
                                   step="1"
                                   required>
                        ...
                        <select name="techniciens[]"
                            ...
                            @foreach($techniciens as $technicien)
                                <option value="{{ $technicien->id }}"
                                    @selected(collect(old('techniciens', $reparation->techniciens->pluck('id')->toArray()))->contains($technicien->id))>
                ...
                <div class="col-lg-4">
                    <div class="help-box">
                        <h5>Modification de réparation</h5>

                        <ul>
                            <li>Vérifiez le véhicule concerné.</li>
                            <li>La durée doit rester en heures entières.</li>
                            <li>Vous pouvez modifier les techniciens affectés.</li>
